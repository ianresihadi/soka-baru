...
| 010 | Pilot UX & Visual Productization | Make the existing MVP feel like a credible pilot product without adding new modules. |
...
| 010 | Requirements, blueprint, acceptance criteria, handoff prompt, Claude start prompt, and placeholder completion notes detailed; ready for Builder pre-edit implementation planning. |
...
- Product polish sufficient for a controlled pilot walkthrough.
...
| 010 Pilot UX & Visual Productization | Selected | The app now works locally, but must feel credible before a school pilot sees it. |
| 011 Pengumuman | Later | Useful parent trust feature, but should wait unless the pilot school explicitly needs announcements before product polish. |
| 011 Raport / Semester Finalization | Defer | Valuable, but would pull SOKA into heavier academic workflow before the MVP is pilot-polished. |
